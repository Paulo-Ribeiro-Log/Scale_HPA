...
const (
	// Resolução mínima do terminal para garantir visibilidade completa
	MinTerminalWidth  = 188 // Largura mínima para todos os elementos serem visíveis
	MinTerminalHeight = 45  // Altura mínima para layout completo
