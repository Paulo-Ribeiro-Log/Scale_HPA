...
func (a *App) handleClusterResourceSelectionKeys(msg tea.KeyMsg) (tea.Model, tea.Cmd) {
	...
	case "1", "2", "3", "4", "5", "6", "7":
		// Filtros rápidos por tipo de recurso
		filterNum, _ := strconv.Atoi(msg.String())
		a.model.ResourceFilter = models.ResourceType(filterNum - 1)
...
func (a *App) handlePrometheusStackKeys(msg tea.KeyMsg) (tea.Model, tea.Cmd) {
	...
	case "enter":
		...
		a.initResourceEditingForm()
	case "1":
		// Filtro Monitoring (mesma lógica que StateClusterResourceSelection)
		a.model.ResourceFilter = models.ResourceMonitoring
		a.model.SelectedIndex = 0
	case "2":
		// Filtro Ingress
		a.model.ResourceFilter = models.ResourceIngress
		a.model.SelectedIndex = 0
	case "3":
		// Filtro Security
		a.model.ResourceFilter = models.ResourceSecurity
		a.model.SelectedIndex = 0
	case "4":
		// Filtro Storage
		a.model.ResourceFilter = models.ResourceStorage
		a.model.SelectedIndex = 0
	case "5":
		// Filtro Networking
		a.model.ResourceFilter = models.ResourceNetworking
		a.model.SelectedIndex = 0
	case "6":
		// Filtro Logging
		a.model.ResourceFilter = models.ResourceLogging
		a.model.SelectedIndex = 0
	case "7":
		// Filtro Custom
		a.model.ResourceFilter = models.ResourceCustom
		a.model.SelectedIndex = 0
	case "p":
		// Preset Small (Dev) - mudamos para 'p' para evitar conflito
		a.applyPrometheusPreset("small")
	case "m":
		// Preset Medium (Prod)
		a.applyPrometheusPreset("medium")
	case "l":
		// Preset Large (Scale)
		a.applyPrometheusPreset("large")
	case "ctrl+d":
